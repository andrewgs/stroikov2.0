<?=form_open_multipart($this->uri->uri_string(),array('class'=>'form-horizontal')); ?>
	...
	<div id="addEstate" class="modal hide fade dmodal">
		...
		<div class="modal-body">
			<fieldset>
				...
				<div class="control-group">
					...
					<div class="controls">
						<input type="text" id="rooms" class="input-small linput" name="rooms">
						<span class="help-inline" style="display:none;">&nbsp;</span>
					</div>
				</div>
				<div class="control-group">
				...
				<div class="control-group">
					...
					<div class="controls">
						<input type="text" id="area" class="input-small linput" name="area">
						<span class="help-inline" style="display:none;">&nbsp;</span>
					</div>
				</div>
				<div class="control-group">
